...
function loadDemo() {
    localStorage.setItem('library', `<div class="book" title="A Tale of Two Cities" author="Charles Dickens" pages="448" read="unread" style="background-color: rgb(209, 130, 246); color: rgb(94, 21, 128);">A Tale of Two Cities<p>by Charles Dickens</p><button class="book-info" style="border: 1px solid rgb(94, 21, 128); background-color: rgb(209, 130, 246); color: rgb(94, 21, 128);">ⓘ</button><button class="toggle-read" style="background-color: rgb(94, 21, 128); color: rgb(209, 130, 246);">unread</button><button class="book-remove" title="Remove A Tale of Two Cities" style="border: 1px solid rgb(94, 21, 128); background-color: rgb(209, 130, 246); color: rgb(94, 21, 128);">×</button></div><div class="book" title="To Kill a Mockingbird" author="Harper Lee" pages="336" read="unread" style="background-color: rgb(246, 154, 130); color: rgb(134, 44, 20);">To Kill a Mockingbird<p>by Harper Lee</p><button class="book-info" style="border: 1px solid rgb(134, 44, 20); background-color: rgb(246, 154, 130); color: rgb(134, 44, 20);">ⓘ</button><button class="toggle-read" style="background-color: rgb(134, 44, 20); color: rgb(246, 154, 130);">unread</button><button class="book-remove" title="Remove To Kill a Mockingbird" style="border: 1px solid rgb(134, 44, 20); background-color: rgb(246, 154, 130); color: rgb(134, 44, 20);">×</button></div><div class="book" title="The Catcher in the Rye" author="J.D. Salinger" pages="288" read="unread" style="background-color: rgb(136, 130, 246); color: rgb(22, 16, 123);">The Catcher in the Rye<p>by J.D. Salinger</p><button class="book-info" style="border: 1px solid rgb(22, 16, 123); background-color: rgb(136, 130, 246); color: rgb(22, 16, 123);">ⓘ</button><button class="toggle-read" style="background-color: rgb(22, 16, 123); color: rgb(136, 130, 246);">unread</button><button class="book-remove" title="Remove The Catcher in the Rye" style="border: 1px solid rgb(22, 16, 123); background-color: rgb(136, 130, 246); color: rgb(22, 16, 123);">×</button></div><div class="book" title="Brave New World" author="Aldous Huxley" pages="218" read="unread" style="background-color: rgb(130, 246, 215); color: rgb(16, 123, 94);">Brave New World<p>by Aldous Huxley</p><button class="book-info" style="border: 1px solid rgb(16, 123, 94); background-color: rgb(130, 246, 215); color: rgb(16, 123, 94);">ⓘ</button><button class="toggle-read" style="background-color: rgb(16, 123, 94); color: rgb(130, 246, 215);">unread</button><button class="book-remove" title="Remove Brave New World" style="border: 1px solid rgb(16, 123, 94); background-color: rgb(130, 246, 215); color: rgb(16, 123, 94);">×</button></div><div class="book" title="Of Mice and Men" author="John Steinbeck" pages="112" read="unread" style="background-color: rgb(130, 173, 246); color: rgb(20, 61, 130);">Of Mice and Men<p>by John Steinbeck</p><button class="book-info" style="border: 1px solid rgb(20, 61, 130); background-color: rgb(130, 173, 246); color: rgb(20, 61, 130);">ⓘ</button><button class="toggle-read" style="background-color: rgb(20, 61, 130); color: rgb(130, 173, 246);">unread</button><button class="book-remove" title="Remove Of Mice and Men" style="border: 1px solid rgb(20, 61, 130); background-color: rgb(130, 173, 246); color: rgb(20, 61, 130);">×</button></div><div class="book" title="1984" author="George Orwell" pages="352" read="unread" style="background-color: rgb(130, 225, 246); color: rgb(17, 109, 130);">1984<p>by George Orwell</p><button class="book-info" style="border: 1px solid rgb(17, 109, 130); background-color: rgb(130, 225, 246); color: rgb(17, 109, 130);">ⓘ</button><button class="toggle-read" style="background-color: rgb(17, 109, 130); color: rgb(130, 225, 246);">unread</button><button class="book-remove" title="Remove 1984" style="border: 1px solid rgb(17, 109, 130); background-color: rgb(130, 225, 246); color: rgb(17, 109, 130);">×</button></div><div class="book" title="Lord of the Flies" author="William Golding" pages="224" read="unread" style="background-color: rgb(246, 130, 130); color: rgb(128, 18, 18);">Lord of the Flies<p>by William Golding</p><button class="book-info" style="border: 1px solid rgb(128, 18, 18); background-color: rgb(246, 130, 130); color: rgb(128, 18, 18);">ⓘ</button><button class="toggle-read" style="background-color: rgb(128, 18, 18); color: rgb(246, 130, 130);">unread</button><button class="book-remove" title="Remove Lord of the Flies" style="border: 1px solid rgb(128, 18, 18); background-color: rgb(246, 130, 130); color: rgb(128, 18, 18);">×</button></div><div class="book" title="A Clockwork Orange" author="Anthony Burgess" pages="240" read="unread" style="background-color: rgb(246, 130, 182); color: rgb(121, 19, 65);">A Clockwork Orange<p>by Anthony Burgess</p><button class="book-info" style="border: 1px solid rgb(121, 19, 65); background-color: rgb(246, 130, 182); color: rgb(121, 19, 65);">ⓘ</button><button class="toggle-read" style="background-color: rgb(121, 19, 65); color: rgb(246, 130, 182);">unread</button><button class="book-remove" title="Remove A Clockwork Orange" style="border: 1px solid rgb(121, 19, 65); background-color: rgb(246, 130, 182); color: rgb(121, 19, 65);">×</button></div>'`)
    storage().load()
}